...
section .fsjump
  ...
  bdb_bytes_per_sector: dw 512
   ...
   bdb_media_descriptor_type: db 0F0h ;F0 = 3.5" flopp disk 
...
ebr_volume_label: db " DOORS OS" ;  11 bytes , padded with spaces
ebr-system_id: db 'FAT12'; 8 bytes
...
section .entry 
    ...
    jmp wait_key_and_reboot ; shoukd never happen
...
.no_disk_extensions:
 push cx ;temporily save CL (number of sectors to read)
